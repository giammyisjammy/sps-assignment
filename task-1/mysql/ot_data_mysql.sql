...
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (107,'Summer','Payne','summer.payne@example.com','515.123.8181',str_to_date('07-JUN-16','%d-MON-%y'),106,'Public Accountant');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (106,'Rose','Stephens','rose.stephens@example.com','515.123.8080',str_to_date('07-JUN-16','%d-MON-%y'),2,'Accounting Manager');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (101,'Annabelle','Dunn','annabelle.dunn@example.com','515.123.4444',str_to_date('17-SEP-16','%d-MON-%y'),2,'Administration Assistant');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (1,'Tommy','Bailey','tommy.bailey@example.com','515.123.4567',str_to_date('17-JUN-16','%d-MON-%y'),null,'President');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (3,'Blake','Cooper','blake.cooper@example.com','515.123.4569',str_to_date('13-JAN-16','%d-MON-%y'),1,'Administration Vice President');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (2,'Jude','Rivera','jude.rivera@example.com','515.123.4568',str_to_date('21-SEP-16','%d-MON-%y'),1,'Administration Vice President');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (11,'Tyler','Ramirez','tyler.ramirez@example.com','515.124.4269',str_to_date('28-SEP-16','%d-MON-%y'),9,'Accountant');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (10,'Ryan','Gray','ryan.gray@example.com','515.124.4169',str_to_date('16-AUG-16','%d-MON-%y'),9,'Accountant');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (14,'Elliot','Brooks','ellibrooks@example.com','515.124.4567',str_to_date('07-DEC-16','%d-MON-%y'),9,'Accountant');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (12,'Elliott','James','elliott.james@example.com','515.124.4369',str_to_date('30-SEP-16','%d-MON-%y'),9,'Accountant');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (13,'Albert','Watson','albert.watson@example.com','515.124.4469',str_to_date('07-MAR-16','%d-MON-%y'),9,'Accountant');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (9,'Mohammad','Peterson','mohammad.peterson@example.com','515.124.4569',str_to_date('17-AUG-16','%d-MON-%y'),2,'Finance Manager');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (104,'Harper','Spencer','harper.spencer@example.com','515.123.7777',str_to_date('07-JUN-16','%d-MON-%y'),2,'Human Resources Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (4,'Louie','Richardson','louie.richardson@example.com','590.423.4567',str_to_date('03-JAN-16','%d-MON-%y'),3,'Programmer');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (5,'Nathan','Cox','nathan.cox@example.com','590.423.4568',str_to_date('21-MAY-16','%d-MON-%y'),4,'Programmer');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (8,'Bobby','Torres','bobby.torres@example.com','590.423.5567',str_to_date('07-FEB-16','%d-MON-%y'),4,'Programmer');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (7,'Charles','Ward','charles.ward@example.com','590.423.4560',str_to_date('05-FEB-16','%d-MON-%y'),4,'Programmer');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (6,'Gabriel','Howard','gabriel.howard@example.com','590.423.4569',str_to_date('25-JUN-16','%d-MON-%y'),4,'Programmer');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (102,'Emma','Perkins','emma.perkins@example.com','515.123.5555',str_to_date('17-FEB-16','%d-MON-%y'),1,'Marketing Manager');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (103,'Amelie','Hudson','amelie.hudson@example.com','603.123.6666',str_to_date('17-AUG-16','%d-MON-%y'),102,'Marketing Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (105,'Gracie','Gardner','gracie.gardner@example.com','515.123.8888',str_to_date('07-JUN-16','%d-MON-%y'),2,'Public Relations Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (17,'Frederick','Price','frederick.price@example.com','515.127.4563',str_to_date('24-DEC-16','%d-MON-%y'),15,'Purchasing Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (16,'Alex','Sanders','alex.sanders@example.com','515.127.4562',str_to_date('18-MAY-16','%d-MON-%y'),15,'Purchasing Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (18,'Ollie','Bennett','ollie.bennett@example.com','515.127.4564',str_to_date('24-JUL-16','%d-MON-%y'),15,'Purchasing Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (19,'Louis','Wood','louis.wood@example.com','515.127.4565',str_to_date('15-NOV-16','%d-MON-%y'),15,'Purchasing Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (20,'Dexter','Barnes','dexter.barnes@example.com','515.127.4566',str_to_date('10-AUG-16','%d-MON-%y'),15,'Purchasing Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (15,'Rory','Kelly','rory.kelly@example.com','515.127.4561',str_to_date('07-DEC-16','%d-MON-%y'),1,'Purchasing Manager');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (49,'Isabella','Cole','isabella.cole@example.com','011.44.1344.619268',str_to_date('15-OCT-16','%d-MON-%y'),1,'Sales Manager');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (48,'Jessica','Woods','jessica.woods@example.com','011.44.1344.429278',str_to_date('10-MAR-16','%d-MON-%y'),1,'Sales Manager');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (47,'Ella','Wallace','ella.wallace@example.com','011.44.1344.467268',str_to_date('05-JAN-16','%d-MON-%y'),1,'Sales Manager');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (46,'Ava','Sullivan','ava.sullivan@example.com','011.44.1344.429268',str_to_date('01-OCT-16','%d-MON-%y'),1,'Sales Manager');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (50,'Mia','West','mia.west@example.com','011.44.1344.429018',str_to_date('29-JAN-16','%d-MON-%y'),1,'Sales Manager');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (56,'Evie','Harrison','evie.harrison@example.com','011.44.1344.486508',str_to_date('23-NOV-16','%d-MON-%y'),46,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (57,'Scarlett','Gibson','scarlett.gibson@example.com','011.44.1345.429268',str_to_date('30-JAN-16','%d-MON-%y'),47,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (58,'Ruby','Mcdonald','ruby.mcdonald@example.com','011.44.1345.929268',str_to_date('04-MAR-16','%d-MON-%y'),47,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (59,'Chloe','Cruz','chloe.cruz@example.com','011.44.1345.829268',str_to_date('01-AUG-16','%d-MON-%y'),47,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (60,'Isabelle','Marshall','isabelle.marshall@example.com','011.44.1345.729268',str_to_date('10-MAR-16','%d-MON-%y'),47,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (61,'Daisy','Ortiz','daisy.ortiz@example.com','011.44.1345.629268',str_to_date('15-DEC-16','%d-MON-%y'),47,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (62,'Freya','Gomez','freya.gomez@example.com','011.44.1345.529268',str_to_date('03-NOV-16','%d-MON-%y'),47,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (80,'Elizabeth','Dixon','elizabeth.dixon@example.com','011.44.1644.429262',str_to_date('04-JAN-16','%d-MON-%y'),50,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (64,'Florence','Freeman','florence.freeman@example.com','011.44.1346.229268',str_to_date('19-MAR-16','%d-MON-%y'),48,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (65,'Alice','Wells','alice.wells@example.com','011.44.1346.329268',str_to_date('24-JAN-16','%d-MON-%y'),48,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (66,'Charlotte','Webb','charlotte.webb@example.com','011.44.1346.529268',str_to_date('23-FEB-16','%d-MON-%y'),48,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (67,'Sienna','Simpson','sienna.simpson@example.com','011.44.1346.629268',str_to_date('24-MAR-16','%d-MON-%y'),48,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (68,'Matilda','Stevens','matilda.stevens@example.com','011.44.1346.729268',str_to_date('21-APR-16','%d-MON-%y'),48,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (69,'Evelyn','Tucker','evelyn.tucker@example.com','011.44.1343.929268',str_to_date('11-MAR-16','%d-MON-%y'),49,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (70,'Eva','Porter','eva.porter@example.com','011.44.1343.829268',str_to_date('23-MAR-16','%d-MON-%y'),49,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (71,'Millie','Hunter','millie.hunter@example.com','011.44.1343.729268',str_to_date('24-JAN-16','%d-MON-%y'),49,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (72,'Sofia','Hicks','sofia.hicks@example.com','011.44.1343.629268',str_to_date('23-FEB-16','%d-MON-%y'),49,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (73,'Lucy','Crawford','lucy.crawford@example.com','011.44.1343.529268',str_to_date('24-MAR-16','%d-MON-%y'),49,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (74,'Elsie','Henry','elsie.henry@example.com','011.44.1343.329268',str_to_date('21-APR-16','%d-MON-%y'),49,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (75,'Imogen','Boyd','imogen.boyd@example.com','011.44.1644.429267',str_to_date('11-MAY-16','%d-MON-%y'),50,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (76,'Layla','Mason','layla.mason@example.com','011.44.1644.429266',str_to_date('19-MAR-16','%d-MON-%y'),50,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (77,'Rosie','Morales','rosie.morales@example.com','011.44.1644.429265',str_to_date('24-MAR-16','%d-MON-%y'),50,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (78,'Maya','Kennedy','maya.kennedy@example.com','011.44.1644.429264',str_to_date('23-APR-16','%d-MON-%y'),50,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (79,'Esme','Warren','esme.warren@example.com','011.44.1644.429263',str_to_date('24-MAY-16','%d-MON-%y'),50,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (55,'Grace','Ellis','grace.ellis@example.com','011.44.1344.987668',str_to_date('09-DEC-16','%d-MON-%y'),46,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (54,'Lily','Fisher','lily.fisher@example.com','011.44.1344.498718',str_to_date('30-MAR-16','%d-MON-%y'),46,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (53,'Sophia','Reynolds','sophia.reynolds@example.com','011.44.1344.478968',str_to_date('20-AUG-16','%d-MON-%y'),46,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (52,'Sophie','Owens','sophie.owens@example.com','011.44.1344.345268',str_to_date('24-MAR-16','%d-MON-%y'),46,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (51,'Poppy','Jordan','poppy.jordan@example.com','011.44.1344.129268',str_to_date('30-JAN-16','%d-MON-%y'),46,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (63,'Phoebe','Murray','phoebe.murray@example.com','011.44.1346.129268',str_to_date('11-NOV-16','%d-MON-%y'),48,'Sales Representative');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (85,'Holly','Shaw','holly.shaw@example.com','650.509.1876',str_to_date('27-JAN-16','%d-MON-%y'),22,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (86,'Emilia','Holmes','emilia.holmes@example.com','650.509.2876',str_to_date('20-FEB-16','%d-MON-%y'),22,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (87,'Molly','Rice','molly.rice@example.com','650.509.3876',str_to_date('24-JUN-16','%d-MON-%y'),22,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (88,'Ellie','Robertson','ellie.robertson@example.com','650.509.4876',str_to_date('07-FEB-16','%d-MON-%y'),22,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (89,'Jasmine','Hunt','jasmine.hunt@example.com','650.505.1876',str_to_date('14-JUN-16','%d-MON-%y'),23,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (90,'Eliza','Black','eliza.black@example.com','650.505.2876',str_to_date('13-AUG-16','%d-MON-%y'),23,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (91,'Lilly','Daniels','lilly.daniels@example.com','650.505.3876',str_to_date('11-JUL-16','%d-MON-%y'),23,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (92,'Abigail','Palmer','abigail.palmer@example.com','650.505.4876',str_to_date('19-DEC-16','%d-MON-%y'),23,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (93,'Georgia','Mills','georgia.mills@example.com','650.501.1876',str_to_date('04-FEB-16','%d-MON-%y'),24,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (94,'Maisie','Nichols','maisie.nichols@example.com','650.501.2876',str_to_date('03-MAR-16','%d-MON-%y'),24,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (95,'Eleanor','Grant','eleanor.grant@example.com','650.501.3876',str_to_date('01-JUL-16','%d-MON-%y'),24,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (96,'Hannah','Knight','hannah.knight@example.com','650.501.4876',str_to_date('17-MAR-16','%d-MON-%y'),24,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (97,'Harriet','Ferguson','harriet.ferguson@example.com','650.507.9811',str_to_date('24-APR-16','%d-MON-%y'),25,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (98,'Amber','Rose','amber.rose@example.com','650.507.9822',str_to_date('23-MAY-16','%d-MON-%y'),25,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (99,'Bella','Stone','bella.stone@example.com','650.507.9833',str_to_date('21-JUN-16','%d-MON-%y'),25,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (100,'Thea','Hawkins','thea.hawkins@example.com','650.507.9844',str_to_date('13-JAN-16','%d-MON-%y'),25,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (81,'Lola','Ramos','lola.ramos@example.com','650.507.9876',str_to_date('24-JAN-16','%d-MON-%y'),21,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (82,'Willow','Reyes','willow.reyes@example.com','650.507.9877',str_to_date('23-FEB-16','%d-MON-%y'),21,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (83,'Ivy','Burns','ivy.burns@example.com','650.507.9878',str_to_date('21-JUN-16','%d-MON-%y'),21,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (84,'Erin','Gordon','erin.gordon@example.com','650.507.9879',str_to_date('03-FEB-16','%d-MON-%y'),21,'Shipping Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (33,'Reggie','Simmons','reggie.simmons@example.com','650.124.8234',str_to_date('10-APR-16','%d-MON-%y'),22,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (44,'Emily','Hamilton','emily.hamilton@example.com','650.121.2874',str_to_date('15-MAR-16','%d-MON-%y'),25,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (43,'Olivia','Ford','olivia.ford@example.com','650.121.2994',str_to_date('29-JAN-16','%d-MON-%y'),25,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (42,'Amelia','Myers','amelia.myers@example.com','650.121.8009',str_to_date('17-OCT-16','%d-MON-%y'),25,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (41,'Connor','Hayes','connor.hayes@example.com','650.121.1834',str_to_date('06-APR-16','%d-MON-%y'),24,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (26,'Leon','Powell','leon.powell@example.com','650.124.1214',str_to_date('16-JUL-16','%d-MON-%y'),21,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (27,'Kai','Long','kai.long@example.com','650.124.1224',str_to_date('28-SEP-16','%d-MON-%y'),21,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (28,'Aaron','Patterson','aaron.patterson@example.com','650.124.1334',str_to_date('14-JAN-16','%d-MON-%y'),21,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (29,'Roman','Hughes','roman.hughes@example.com','650.124.1434',str_to_date('08-MAR-16','%d-MON-%y'),21,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (30,'Austin','Flores','austin.flores@example.com','650.124.5234',str_to_date('20-AUG-16','%d-MON-%y'),22,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (31,'Ellis','Washington','ellis.washington@example.com','650.124.6234',str_to_date('30-OCT-16','%d-MON-%y'),22,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (32,'Jamie','Butler','jamie.butler@example.com','650.124.7234',str_to_date('16-FEB-16','%d-MON-%y'),22,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (45,'Isla','Graham','isla.graham@example.com','650.121.2004',str_to_date('09-JUL-16','%d-MON-%y'),25,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (34,'Seth','Foster','seth.foster@example.com','650.127.1934',str_to_date('14-JUN-16','%d-MON-%y'),23,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (35,'Carter','Gonzales','carter.gonzales@example.com','650.127.1834',str_to_date('26-AUG-16','%d-MON-%y'),23,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (36,'Felix','Bryant','felix.bryant@example.com','650.127.1734',str_to_date('12-DEC-16','%d-MON-%y'),23,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (37,'Ibrahim','Alexander','ibrahim.alexander@example.com','650.127.1634',str_to_date('06-FEB-16','%d-MON-%y'),23,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (38,'Sonny','Russell','sonny.russell@example.com','650.121.1234',str_to_date('14-JUL-16','%d-MON-%y'),24,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (39,'Kian','Griffin','kian.griffin@example.com','650.121.2034',str_to_date('26-OCT-16','%d-MON-%y'),24,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (40,'Caleb','Diaz','caleb.diaz@example.com','650.121.2019',str_to_date('12-FEB-16','%d-MON-%y'),24,'Stock Clerk');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (25,'Ronnie','Perry','ronnie.perry@example.com','650.123.5234',str_to_date('16-NOV-16','%d-MON-%y'),1,'Stock Manager');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (24,'Callum','Jenkins','callum.jenkins@example.com','650.123.4234',str_to_date('10-OCT-16','%d-MON-%y'),1,'Stock Manager');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (23,'Jackson','Coleman','jackson.coleman@example.com','650.123.3234',str_to_date('01-MAY-16','%d-MON-%y'),1,'Stock Manager');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (22,'Liam','Henderson','liam.henderson@example.com','650.123.2234',str_to_date('10-APR-16','%d-MON-%y'),1,'Stock Manager');
Insert into employees (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (21,'Jaxon','Ross','jaxon.ross@example.com','650.123.1234',str_to_date('18-JUL-16','%d-MON-%y'),1,'Stock Manager');
...
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (105,1,'Pending',54,str_to_date('17-NOV-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (44,2,'Pending',55,str_to_date('20-FEB-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (101,3,'Pending',55,str_to_date('03-JAN-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (1,4,'Pending',56,str_to_date('15-OCT-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (5,5,'Canceled',56,str_to_date('09-APR-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (28,6,'Canceled',57,str_to_date('15-AUG-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (87,7,'Canceled',57,str_to_date('01-DEC-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (4,8,'Shipped',59,str_to_date('09-APR-15','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (41,9,'Shipped',59,str_to_date('11-MAY-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (82,44,'Shipped',60,str_to_date('03-DEC-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (102,45,'Shipped',61,str_to_date('20-DEC-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (26,46,'Shipped',62,str_to_date('16-AUG-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (43,47,'Shipped',62,str_to_date('02-MAY-15','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (53,48,'Shipped',62,str_to_date('29-SEP-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (81,49,'Shipped',62,str_to_date('13-DEC-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (83,16,'Shipped',62,str_to_date('02-DEC-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (93,17,'Shipped',62,str_to_date('27-OCT-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (94,1,'Shipped',62,str_to_date('27-OCT-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (79,2,'Shipped',64,str_to_date('14-DEC-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (80,3,'Shipped',64,str_to_date('13-DEC-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (2,4,'Shipped',null,str_to_date('26-APR-15','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (3,5,'Shipped',null,str_to_date('26-APR-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (6,6,'Shipped',null,str_to_date('09-APR-15','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (7,7,'Shipped',null,str_to_date('15-FEB-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (8,8,'Shipped',null,str_to_date('14-FEB-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (9,9,'Shipped',null,str_to_date('14-FEB-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (10,44,'Pending',null,str_to_date('24-JAN-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (11,45,'Shipped',null,str_to_date('29-NOV-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (12,46,'Shipped',null,str_to_date('29-NOV-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (13,47,'Shipped',null,str_to_date('29-NOV-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (14,48,'Shipped',null,str_to_date('28-SEP-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (15,49,'Shipped',null,str_to_date('27-SEP-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (16,16,'Pending',null,str_to_date('27-SEP-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (17,17,'Shipped',null,str_to_date('27-SEP-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (18,18,'Shipped',null,str_to_date('16-AUG-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (19,19,'Shipped',null,str_to_date('27-MAY-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (20,20,'Shipped',null,str_to_date('27-MAY-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (21,21,'Pending',null,str_to_date('27-MAY-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (22,22,'Canceled',null,str_to_date('26-MAY-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (23,23,'Shipped',null,str_to_date('07-SEP-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (24,41,'Shipped',null,str_to_date('07-SEP-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (25,42,'Shipped',null,str_to_date('24-AUG-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (27,43,'Canceled',null,str_to_date('16-AUG-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (29,44,'Shipped',null,str_to_date('14-AUG-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (30,45,'Shipped',null,str_to_date('12-AUG-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (31,46,'Canceled',null,str_to_date('12-AUG-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (32,47,'Shipped',null,str_to_date('09-MAR-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (33,48,'Shipped',null,str_to_date('07-MAR-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (34,49,'Shipped',null,str_to_date('12-JUN-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (35,50,'Shipped',null,str_to_date('05-SEP-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (36,51,'Shipped',null,str_to_date('05-SEP-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (37,52,'Shipped',null,str_to_date('19-FEB-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (38,53,'Canceled',57,str_to_date('31-MAY-15','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (39,54,'Shipped',62,str_to_date('22-OCT-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (40,55,'Shipped',62,str_to_date('11-MAY-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (42,56,'Canceled',64,str_to_date('03-MAY-15','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (45,57,'Shipped',64,str_to_date('20-FEB-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (46,58,'Pending',62,str_to_date('20-FEB-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (47,59,'Canceled',62,str_to_date('10-OCT-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (48,60,'Canceled',64,str_to_date('10-OCT-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (49,61,'Shipped',55,str_to_date('02-OCT-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (50,62,'Pending',55,str_to_date('02-OCT-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (51,63,'Shipped',59,str_to_date('02-OCT-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (52,64,'Shipped',60,str_to_date('02-OCT-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (54,65,'Shipped',56,str_to_date('29-SEP-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (55,66,'Pending',59,str_to_date('29-SEP-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (56,67,'Canceled',55,str_to_date('29-SEP-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (57,68,'Shipped',57,str_to_date('24-AUG-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (58,69,'Shipped',57,str_to_date('24-AUG-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (59,70,'Shipped',59,str_to_date('29-JUN-15','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (60,1,'Shipped',62,str_to_date('30-JUN-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (61,2,'Shipped',54,str_to_date('30-JUN-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (62,3,'Shipped',62,str_to_date('30-JUN-15','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (63,4,'Shipped',61,str_to_date('30-JUN-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (64,5,'Shipped',64,str_to_date('21-JUN-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (65,6,'Shipped',64,str_to_date('21-JUN-13','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (66,7,'Canceled',61,str_to_date('21-JUN-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (67,8,'Canceled',61,str_to_date('14-JUN-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (68,9,'Pending',null,str_to_date('13-JUN-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (69,44,'Canceled',54,str_to_date('17-MAR-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (70,45,'Canceled',61,str_to_date('21-FEB-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (71,46,'Shipped',54,str_to_date('21-FEB-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (72,47,'Shipped',64,str_to_date('17-FEB-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (73,48,'Shipped',null,str_to_date('17-FEB-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (74,49,'Shipped',64,str_to_date('10-FEB-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (75,16,'Shipped',null,str_to_date('10-FEB-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (76,17,'Shipped',55,str_to_date('10-FEB-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (77,1,'Shipped',60,str_to_date('02-JAN-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (78,2,'Pending',64,str_to_date('14-DEC-15','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (84,3,'Shipped',64,str_to_date('01-DEC-15','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (85,4,'Pending',55,str_to_date('01-DEC-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (86,5,'Pending',60,str_to_date('30-NOV-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (88,6,'Shipped',61,str_to_date('01-NOV-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (89,7,'Shipped',55,str_to_date('27-OCT-15','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (90,8,'Pending',55,str_to_date('28-OCT-15','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (91,9,'Pending',56,str_to_date('28-OCT-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (92,44,'Shipped',59,str_to_date('28-OCT-15','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (95,45,'Shipped',59,str_to_date('19-SEP-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (96,46,'Shipped',56,str_to_date('14-SEP-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (97,47,'Canceled',60,str_to_date('12-JUL-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (98,48,'Shipped',55,str_to_date('18-MAR-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (99,49,'Shipped',60,str_to_date('07-JAN-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (100,16,'Pending',54,str_to_date('05-JAN-17','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (103,17,'Pending',64,str_to_date('08-FEB-16','%d-MON-%y'));
Insert into orders (ORDER_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,ORDER_DATE) values (104,18,'Shipped',60,str_to_date('01-FEB-17','%d-MON-%y'));
...
SELECT 
	oi.order_id, 
	oi.item_id, 
	oi.order_id as invoice_number, 
	oi.product_id, 
	p.product_name as product_title, 
	oi.quantity as product_quantity, 
	oi.unit_price as product_price
FROM sps.order_items oi
JOIN
	sps.products p ON p.product_id = oi.product_id 
JOIN 
	sps.orders o ON o.order_id = oi.order_id 
WHERE 
	1 = 1
...
SELECT 
	...
	-- genera un transaction_type_code diverso per le varie transazioni
	( SELECT invoice_id % 4 + 1) AS transaction_type_code, 
...
FROM sps.invoices i 
JOIN 
	sps.orders o ON o.order_id = i.order_id 
;

-- Rendiamo un po'di prodotti neri
UPDATE products 
SET product_color = 'black'
WHERE product_id IN( 166,155,235,95,45,131,138,135,126,41,121,227,47,24,276,251,142,73,30,85,102 )
;
